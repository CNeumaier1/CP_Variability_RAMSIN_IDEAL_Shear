...
This repository also contains the RAMS model namelists, model output, and files used for figures for the Cold Pool Trains Manuscript.

The namelists are in the folder "RAMSINs_CPTrains".
The model output files used to create the figures, supplementary figures, and supplementary table are in the folder "Figure_Files".
